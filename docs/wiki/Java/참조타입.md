- [데이터 타입 분류](#데이터 타입 분류)
	- [기본 타입](#데이터 타입 분류#기본 타입)
	- [참조 타입](#데이터 타입 분류#참조 타입)
	- [기본 변수 vs 참조 변수](#데이터 타입 분류#기본 변수 vs 참조 변수)
- [메모리 사용 영역](#메모리 사용 영역)
- [Java 메모리 구조](#Java 메모리 구조)
	- [메소드(Method) 영역](#Java 메모리 구조#메소드(Method) 영역)
	- [힙(Heap) 영역](#Java 메모리 구조#힙(Heap) 영역)
	- [JVM 스택(Stack) 영역](#Java 메모리 구조#JVM 스택(Stack) 영역)
		- [JVM 스택 작동 방법](#JVM 스택(Stack) 영역#JVM 스택 작동 방법)
- [참조 타입 변수의 `<mark>, !</mark>` 연산](#참조 타입 변수의 `<mark>, !</mark>` 연산)
- [null과 NullPointerException](#null과 NullPointerException)
- [String 타입](#String 타입)
	- [문자열 비교](#String 타입#문자열 비교)
	- [문자 추출](#String 타입#문자 추출)
- [Array 타입](#Array 타입)
	- [배열 변수 선언](#Array 타입#배열 변수 선언)
	- [값 목록으로 배열 생성](#Array 타입#값 목록으로 배열 생성)
	- [new 연산자로 배열 생성](#Array 타입#new 연산자로 배열 생성)
- [다차원 배열](#다차원 배열)
	- [new 연산자로 다차원 배열 생성](#다차원 배열#new 연산자로 다차원 배열 생성)
- [객체를 참조하는 배열](#객체를 참조하는 배열)
