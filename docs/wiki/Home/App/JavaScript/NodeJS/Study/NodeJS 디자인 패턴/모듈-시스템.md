...
![이미지/미분류/NodeJs/Node/NodeJS 디자인 패턴/2.모듈 시스템/Diagram-1.svg](/img/이미지 창고/Diagram-1.svg)
...
![이미지/미분류/NodeJs/Node/NodeJS 디자인 패턴/2.모듈 시스템/Diagram.svg](/img/이미지 창고/Diagram.svg)
...
![이미지/미분류/NodeJs/Node/NodeJS 디자인 패턴/2.모듈 시스템/Diagram-2.svg](/img/이미지 창고/Diagram-2.svg)
...
![이미지/미분류/NodeJs/Node/NodeJS 디자인 패턴/2.모듈 시스템/Diagram-3.svg](/img/이미지 창고/Diagram-3.svg)
