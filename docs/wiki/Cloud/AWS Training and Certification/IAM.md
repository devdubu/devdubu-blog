...
![Pasted-image-20230629110941.png](/img/이미지 창고/Pasted-image-20230629110941.png)
# IAM : Permissions
- 왜 User와 Group으로 나눌까?
...
![Pasted-image-20230629111330.png](/img/이미지 창고/Pasted-image-20230629111330.png)
...
![Pasted-image-20230629130336.png](/img/이미지 창고/Pasted-image-20230629130336.png)
- 해당 계정ID는 복잡한 숫자로 구성되어있다.
- 이러한 복잡한 숫자는 구별하기 어렵기 때문에, 아래와 같이 계정 별칭을 지정해서 문자로 
![Pasted-image-20230629130430.png](/img/이미지 창고/Pasted-image-20230629130430.png)
- 위의 별칭은 고유하기 때문에 다른 User가 사용할 수 없습니다.

# IAM Policies inheritance
![Pasted-image-20230629125325.png](/img/이미지 창고/Pasted-image-20230629125325.png)
...
![Pasted-image-20230629131211.png](/img/이미지 창고/Pasted-image-20230629131211.png)
...
![Pasted-image-20230630092803.png](/img/이미지 창고/Pasted-image-20230630092803.png)
- 해당 로그인 방식은, 만약 비밀번호가 누출된 상태에서도 로그인을 위해서는 휴대폰과 같이 Alice의 물리적인 장치가 추가적으로 필요하기 계정이 침해 받지 않습니다.

## MFA devices options in AWS

### Virtual MFA device
![Pasted-image-20230630093137.png](/img/이미지 창고/Pasted-image-20230630093137.png)
...
![Pasted-image-20230630093227.png](/img/이미지 창고/Pasted-image-20230630093227.png)
...
![Pasted-image-20230630093246.png](/img/이미지 창고/Pasted-image-20230630093246.png)
- Gemalto의 제품입니다.


### Hardware Key Fod MFA Device for AWS GovCloud(US)
![Pasted-image-20230630093253.png](/img/이미지 창고/Pasted-image-20230630093253.png)
...
![Pasted-image-20230630095211.png](/img/이미지 창고/Pasted-image-20230630095211.png)

## What's the AWS CLI
- AWS CLI는 CLI 명령어를 이용해서 AWS 서비스들과 상호작용할 수 있게 해주는 것을 의미한다.
- CLI를 사용하면 AWS 서비스의 공용 API로 직접 액세스가 가능합니다.

![Pasted-image-20230630095321.png](/img/이미지 창고/Pasted-image-20230630095321.png)

# What's the AWS SDK?
![Pasted-image-20230704090435.png](/img/이미지 창고/Pasted-image-20230704090435.png)
...
# CloudShell
![Pasted-image-20230704092103.png](/img/이미지 창고/Pasted-image-20230704092103.png)
- Cloud Shell 자체에서는 Terminal 처럼 지원하기 때문에, 굳이 local terminal을 사용하지 않아도 된다.
![Pasted-image-20230704092339.png](/img/이미지 창고/Pasted-image-20230704092339.png)
- 위처럼 AWS 명령어도 잘 동작하고 있다.
![Pasted-image-20230704092423.png](/img/이미지 창고/Pasted-image-20230704092423.png)
- 위 환경 설정에는 다양한 옵션들이 존재하기에, 해당 옵션을 통해서 원하는 설정을 가지고 가면 된다.
- 자체 내장 저장소가 있기 때문에, 아래와 같이 파일 업로드 및 다운로드가 가능하다.
![Pasted-image-20230704092544.png](/img/이미지 창고/Pasted-image-20230704092544.png)
...
![Pasted-image-20230704093856.png](/img/이미지 창고/Pasted-image-20230704093856.png)
...
![Pasted-image-20230704095712.png](/img/이미지 창고/Pasted-image-20230704095712.png)
![Pasted-image-20230704100052.png](/img/이미지 창고/Pasted-image-20230704100052.png)
- 이외 나머지는 시험과 실습에 필요가 없다.
- AWS Service 역할을 만들 수 있다는 것을 알면 된다.
- 아래에서 가장 일반적인 사용 사례는 두가지 입니다.
	- EC2 인스턴스 또는 Lambda함수에 대한 역할을 만드는 것입니다.
![Pasted-image-20230704100336.png](/img/이미지 창고/Pasted-image-20230704100336.png)

![Pasted-image-20230704100422.png](/img/이미지 창고/Pasted-image-20230704100422.png)
- 위의 정책을 설정하면 EC2 인스턴스가 IAM을 읽을 수 있다.
![Pasted-image-20230704100528.png](/img/이미지 창고/Pasted-image-20230704100528.png)
![Pasted-image-20230704100552.png](/img/이미지 창고/Pasted-image-20230704100552.png)
# IAM Security Tools
...
## 실습
- 자격 증명 보고서를 만들어보겠습니다.
![Pasted-image-20230704102108.png](/img/이미지 창고/Pasted-image-20230704102108.png)
![Pasted-image-20230704102132.png](/img/이미지 창고/Pasted-image-20230704102132.png)
- 위 버튼을 통해서 자격 증명 보고서를 다운 받습니다.

![Pasted-image-20230704102320.png](/img/이미지 창고/Pasted-image-20230704102320.png)
- 해당 내용은 계정의 보안 적인 측면을 한꺼번에 확인이 가능하다.

### IAM 액세스 관리자
![Pasted-image-20230704102541.png](/img/이미지 창고/Pasted-image-20230704102541.png)
- `Users` 클릭 후 본인의 User name을 선택합니다.
![Pasted-image-20230704102655.png](/img/이미지 창고/Pasted-image-20230704102655.png)
- `Access Advisor`를 클릭하게 되면, 지속적으로 접속 했던 Resource가 뜨게 됩니다.
- 

![Pasted-image-20230704102827.png](/img/이미지 창고/Pasted-image-20230704102827.png)
