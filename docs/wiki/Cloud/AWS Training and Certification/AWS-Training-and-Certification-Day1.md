...
---
- [DevOps 소개](#DevOps 소개)
	- [DevOps란?](#DevOps 소개#DevOps란?)
	- [Amazon의 개발](#DevOps 소개#Amazon의 개발)
	- [모놀리식의 문제점](#DevOps 소개#모놀리식의 문제점)
	- [Aamzon의 MSA](#DevOps 소개#Aamzon의 MSA)
	- [소규모 팀 속성](#DevOps 소개#소규모 팀 속성)
	- [DevOps 혁신을 주도하는 요인](#DevOps 소개#DevOps 혁신을 주도하는 요인)
- [DevOps 문화](#DevOps 문화)
		- [속도](#DevOps 혁신을 주도하는 요인#속도)
		- [신속한 제공](#DevOps 혁신을 주도하는 요인#신속한 제공)
		- [안정성](#DevOps 혁신을 주도하는 요인#안정성)
		- [확장](#DevOps 혁신을 주도하는 요인#확장)
		- [협업 강화](#DevOps 혁신을 주도하는 요인#협업 강화)
		- [보안](#DevOps 혁신을 주도하는 요인#보안)
	- [지속적 전달](#DevOps 문화#지속적 전달)
		- [지속적 통합(CI)](#지속적 전달#지속적 통합(CI))
		- [지속적 전달(CD)](#지속적 전달#지속적 전달(CD))
	- [MSA 이전 모놀리식](#DevOps 문화#MSA 이전 모놀리식)
	- [MSA](#DevOps 문화#MSA)
	- [Infrastructure as Code](#DevOps 문화#Infrastructure as Code)
	- [모니터링 및 로깅](#DevOps 문화#모니터링 및 로깅)
	- [커뮤니케이션 및 협업](#DevOps 문화#커뮤니케이션 및 협업)
	- [최신 애플리케이션 및 아키텍처](#DevOps 문화#최신 애플리케이션 및 아키텍처)
	- [AWS 기반 DevOps](#DevOps 문화#AWS 기반 DevOps)
- [인프라 자동화](#인프라 자동화)
	- [자동화가 필요한 이유?](#인프라 자동화#자동화가 필요한 이유?)
		- [코드형 인프라의 구성 요소](#자동화가 필요한 이유?#코드형 인프라의 구성 요소)
			- [자동화가 중요한 이유](#코드형 인프라의 구성 요소#자동화가 중요한 이유)
	- [자동 인프라 프로비저닝](#인프라 자동화#자동 인프라 프로비저닝)
	- [코드형 인프라의 이점](#인프라 자동화#코드형 인프라의 이점)
			- [코드형 인프라를 통해 다음이 가능하다.](#코드형 인프라의 구성 요소#코드형 인프라를 통해 다음이 가능하다.)
	- [AWS CloudFormation과 DevOps](#인프라 자동화#AWS CloudFormation과 DevOps)
	- [AWS CloudFormation 템플릿 구조 : YAML 형식](#인프라 자동화#AWS CloudFormation 템플릿 구조 : YAML 형식)
	- [파라미터](#인프라 자동화#파라미터)
	- [파라미터 검증](#인프라 자동화#파라미터 검증)
	- [CreationPolicy 속성](#인프라 자동화#CreationPolicy 속성)
	- [Auto CloudFormation 모범 사례](#인프라 자동화#Auto CloudFormation 모범 사례)
	- [AWS CloudFormation 스택](#인프라 자동화#AWS CloudFormation 스택)
	- [스택: 계층화된 아키텍쳐 접근 방식](#인프라 자동화#스택: 계층화된 아키텍쳐 접근 방식)
	- [stack : 중첩 스택 접근 방식](#인프라 자동화#stack : 중첩 스택 접근 방식)
	- [스택 : 중첩 스택을 사용한 계층화](#인프라 자동화#스택 : 중첩 스택을 사용한 계층화)
	- [MSA](#인프라 자동화#MSA)
	- [스택 업데이트](#인프라 자동화#스택 업데이트)
	- [변경 세트](#인프라 자동화#변경 세트)
	- [변경 세트를 사용하여 스택 업데이트](#인프라 자동화#변경 세트를 사용하여 스택 업데이트)
	- [변경 세트 생성](#인프라 자동화#변경 세트 생성)
	- [AWS CloudFormation Helper Script](#인프라 자동화#AWS CloudFormation Helper Script)
	- [cfn-hup 작동 방식](#인프라 자동화#cfn-hup 작동 방식)
	- [예시 : cfn-hup.conf configuration](#인프라 자동화#예시 : cfn-hup.conf configuration)
		- [cfn-hub.conf](#예시 : cfn-hup.conf configuration#cfn-hub.conf)
		- [hooks.conf](#예시 : cfn-hup.conf configuration#hooks.conf)
	- [AWS CloudFormation StackSets](#인프라 자동화#AWS CloudFormation StackSets)
	- [예시 : DeletionPolicy](#인프라 자동화#예시 : DeletionPolicy)
		- [DeletionPolicy 옵션](#예시 : DeletionPolicy#DeletionPolicy 옵션)
		- [옵션](#예시 : DeletionPolicy#옵션)
	- [스택에서 드리프트 감지](#인프라 자동화#스택에서 드리프트 감지)
	- [방해가 되는 작업 방지](#인프라 자동화#방해가 되는 작업 방지)
	- [사용자 지정 리소스](#인프라 자동화#사용자 지정 리소스)


# DevOps 소개

## DevOps란?
![Pasted-image-20230322171034.png](/img/이미지 창고/Pasted-image-20230322171034.png)
:::info DevOps란?
...
## Amazon의 개발
![Pasted-image-20230322171539.png](/img/이미지 창고/Pasted-image-20230322171539.png)
...
![Pasted-image-20230322174146.png](/img/이미지 창고/Pasted-image-20230322174146.png)
...
## 소규모 팀 속성
![Pasted-image-20230322174545.png](/img/이미지 창고/Pasted-image-20230322174545.png)
...
## DevOps 혁신을 주도하는 요인
![Screenshot-2023-03-22-at-5.50.43-PM.png](/img/이미지 창고/Screenshot-2023-03-22-at-5.50.43-PM.png)
...
## 지속적 전달
![Pasted-image-20230322225938.png](/img/이미지 창고/Pasted-image-20230322225938.png)
...
## MSA 이전 모놀리식
![Screenshot-2023-03-22-at-11.07.06-PM.png](/img/이미지 창고/Screenshot-2023-03-22-at-11.07.06-PM.png)
...
## MSA
![Screenshot-2023-03-22-at-11.08.30-PM.png](/img/이미지 창고/Screenshot-2023-03-22-at-11.08.30-PM.png)
- 샘플 MSA는 위에 표시 됩니다.
...
![Screenshot-2023-03-25-at-12.00.29-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-12.00.29-PM.png)
...
## 모니터링 및 로깅
![Pasted-image-20230325120532.png](/img/이미지 창고/Pasted-image-20230325120532.png)
...
## 커뮤니케이션 및 협업
![Pasted-image-20230325121013.png](/img/이미지 창고/Pasted-image-20230325121013.png)
...
## AWS 기반 DevOps
![Screenshot-2023-03-25-at-12.35.13-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-12.35.13-PM.png)
...
## CreationPolicy 속성
![Screenshot-2023-03-25-at-4.52.20-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-4.52.20-PM.png)
...
- 공통 파라미터:
	...
	- TimeoutInMinutes
- 기존 리소스 가져오기
![Screenshot-2023-03-25-at-5.07.50-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-5.07.50-PM.png)
...
## 스택: 계층화된 아키텍쳐 접근 방식
![Screenshot-2023-03-25-at-5.17.15-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-5.17.15-PM.png)
:::question AWS CloudFormation 템플릿의 생성 및 관리 계획은 어떻게?

:::

## stack : 중첩 스택 접근 방식
![Screenshot-2023-03-25-at-5.18.11-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-5.18.11-PM.png)
...
## 스택 : 중첩 스택을 사용한 계층화
![Screenshot-2023-03-25-at-5.26.49-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-5.26.49-PM.png)
- 중첩된 스택을 사용하면 다수의 동일한 템플릿을 결합할 때 세부적으로 제어할 수 있다.
...
![Screenshot-2023-03-25-at-5.33.19-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-5.33.19-PM.png)

## MSA
![Screenshot-2023-03-25-at-5.34.13-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-5.34.13-PM.png)
...
## 스택 업데이트
![Screenshot-2023-03-25-at-5.59.22-PM.png](/img/이미지 창고/Screenshot-2023-03-25-at-5.59.22-PM.png)
...
## 변경 세트를 사용하여 스택 업데이트
![Pasted-image-20230327082155.png](/img/이미지 창고/Pasted-image-20230327082155.png)
...
![Pasted-image-20230327100038.png](/img/이미지 창고/Pasted-image-20230327100038.png)
...
|IAM 사용자/역할| IAM 정책|
![Pasted-image-20230327112856.png](/img/이미지 창고/Pasted-image-20230327112856.png)
...
## 예시) 사용자 지정 리소스 워크플로
![Pasted-image-20230413091211.png](/img/이미지 창고/Pasted-image-20230413091211.png)
...
### AWS TaskCat
![Pasted-image-20230413094518.png](/img/이미지 창고/Pasted-image-20230413094518.png)
