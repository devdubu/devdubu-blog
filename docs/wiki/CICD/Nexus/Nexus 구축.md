...
---
# Nexus Blob Store 생성
![Screenshot-2023-01-25-at-11.30.37-PM.png](/img/Screenshot%202023%2001%2025%20at%2011.30.37%20PM.png)
- 위의 사진과 같이 생성해주면 된다.

# Nexus Docker Repository 구축
- 우선 Nexus에서 Docker Repository를 구축하기 위해서 아래 사진의 3가지가 가지는 의미를 알아야한다.
![Screenshot-2023-01-25-at-11.18.09-PM.png](/img/Screenshot%202023%2001%2025%20at%2011.18.09%20PM.png)
## docker(group)
...
![Screenshot-2023-01-25-at-11.32.24-PM.png](/img/Screenshot%202023%2001%2025%20at%2011.32.24%20PM.png)
- 생성된 Repository를 클릭하게 된다면 아래와 같은 사진으로 나오게 된다.
![Screenshot-2023-01-25-at-11.33.52-PM.png](/img/Screenshot%202023%2001%2025%20at%2011.33.52%20PM.png)
- 위의 URL을 통해서 Docker Image를 push, pull 할 것이기 때문에 잘 기억해야한다.
- 해당 위 URL 부분은 8081 포트가 아닌 5050포트를 사용해야한다.


## Realms 설정
![Screenshot-2023-01-25-at-11.35.48-PM.png](/img/Screenshot%202023%2001%2025%20at%2011.35.48%20PM.png)
