...
![Pasted-image-20230110141001.png](/img/Pasted-image-20230110141001.png)
- 사용자가 상품 등록 폼에서 정상 범위의 데이터를 입력하면, 서버에서는 검증 로직이 통과하고, 상품을 저장하고, 상품 상세 화면으로 redirect한다.
![Pasted-image-20230110141224.png](/img/Pasted-image-20230110141224.png)
...
# Project Setting V2
![Pasted-image-20230110174615.png](/img/Pasted-image-20230110174615.png)
![Pasted-image-20230110174625.png](/img/Pasted-image-20230110174625.png)
## bindingResult
...
- [BindingResult 와 Errors](BindingResult-와-Errors.md)
...
[FieldError 생성자](FieldError-생성자.md)
