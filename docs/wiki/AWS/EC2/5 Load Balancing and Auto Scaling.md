...
![Pasted-image-20230829152253.png](/img/Pasted%20image%2020230829152253.png)
...
![Pasted-image-20230829173046.png](/img/Pasted%20image%2020230829173046.png)
...
![Pasted-image-20230830171730.png](/img/Pasted%20image%2020230830171730.png)
...
![Pasted-image-20230829170037.png](/img/Pasted%20image%2020230829170037.png)

로드 밸런서와 백엔드 EC2 인스턴스 간의 보안 그룹 구성은 다음과 같이 설정해야 합니다.

1. **Load Balancer SG**: 외부 사용자(Anywhere `0.0.0.0/0`)로부터 HTTP/HTTPS 트래픽 허용.
   ![Pasted-image-20230829170230.png](/img/Pasted%20image%2020230829170230.png)

2. **Backend EC2 SG**: **오직 Load Balancer의 보안 그룹**으로부터 오는 트래픽만 허용.
   ![Pasted-image-20230829170443.png](/img/Pasted%20image%2020230829170443.png)
   - 이렇게 하면 사용자가 EC2 인스턴스에 직접 접근하는 것을 막고, 모든 트래픽이 반드시 로드 밸런서를 거치도록 강제할 수 있습니다.

---

## Auto Scaling Group (ASG)
![Pasted-image-20231204103212.png](/img/Pasted%20image%2020231204103212.png)
:::tip 목적
