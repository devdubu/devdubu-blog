...
![Pasted image 20230704180548.png](../../../../Pasted image 20230704180548.png)
- 왼쪽 상단에 `Billing Dashboard`를 클릭합니다.
![Pasted image 20230704180759.png](../../../../Pasted image 20230704180759.png)
- 현재 관리자 계정임에도 불구하고, Billing Dashboard가 활성화 되지 않는 모습을 볼 수 있습니다.
- 해당 DashBoard는 오직 Root 계정 만이 활성화 할 수 있고, 설정 할 수 있습니다.
![Pasted image 20230704181228.png](../../../../Pasted image 20230704181228.png)
- Root 계정으로 접근하게 된다면, 위와 같은 화면이 뜨게 됩니다.
![Pasted image 20230704181712.png](../../../../Pasted image 20230704181712.png)
![Pasted image 20230704181736.png](../../../../Pasted image 20230704181736.png)
...
![Pasted image 20230705084523.png](../../../../Pasted image 20230705084523.png)
![Pasted image 20230705084727.png](../../../../Pasted image 20230705084727.png)
- 어떤 서비스에서 얼마나 부과 됐는지 뜨는 화면입니다.

### 청구된 비용 알림
![Pasted image 20230705084955.png](../../../../Pasted image 20230705084955.png)
- 왼쪽 메뉴란에 `Free tier` 를 클릭합니다.
- 가장 좋은 방법은 예산을 설정하는 것 입니다.
- 왼쪽 메뉴에 `Budgets`으로 들어갑니다.
![Pasted image 20230705085430.png](../../../../Pasted image 20230705085430.png)
![Pasted image 20230705085509.png](../../../../Pasted image 20230705085509.png)
- Create budget을 누르면, 한도에 도달하려고 한다면 알림을 받을 수 있습니다.
![Pasted image 20230705085840.png](../../../../Pasted image 20230705085840.png)
- AWS `Zero spend budget`을 선택하게 된다면, 프리티어 한도를 초과하는 순간 알림을 보내줍니다.
![Pasted image 20230705091341.png](../../../../Pasted image 20230705091341.png)
- 위의 화면과 같이 구성할 수 있습니다.
- `Thresholds`에서 `Exceeds`라고 뜬 상태는 이미, 해당하는 요금이 넘었다는 상태입니다.

# Amazon EC2
![Pasted image 20230705091629.png](../../../../Pasted image 20230705091629.png)
...
![Pasted image 20230706084914.png](../../../../Pasted image 20230706084914.png)
![Pasted image 20230706085013.png](../../../../Pasted image 20230706085013.png)
- 해당 란에 처음 시작 시에, 실행하는 script를 작성하면 됩니다.


# EC2 인스턴스 타입
![Pasted image 20230705095714.png](../../../../Pasted image 20230705095714.png)
- [EC2 인스턴스 타입](https://aws.amazon.com/ko/ec2/instance-types/)
## AWS 인스턴스 네이밍 규칙
- 인스턴스 네이밍에도 규칙이 있습니다.
- 아래의 사진으로 예를 들겠습니다.
![Pasted image 20230706090829.png](../../../../Pasted image 20230706090829.png)
- **m** : 인스턴스 Class
...
![Pasted image 20230706091738.png](../../../../Pasted image 20230706091738.png)
...
![Pasted image 20230706091750.png](../../../../Pasted image 20230706091750.png)
...
![Pasted image 20230706093928.png](../../../../Pasted image 20230706093928.png)
...
![Pasted image 20230706093846.png](../../../../Pasted image 20230706093846.png)
...
![Pasted image 20230713090829.png](../../../../Pasted image 20230713090829.png)

## Security Group Diagram
![Pasted image 20230713091555.png](../../../../Pasted image 20230713091555.png)
### Inbound
...
![Pasted image 20230713094329.png](../../../../Pasted image 20230713094329.png)
### inbound
...
![Pasted image 20230713100423.png](../../../../Pasted image 20230713100423.png)
- 위 사진은 SSH 접속을 위해서 사용되는 도구를 나탸냅니다.

## Mac / Linux 
- Linux or Mac 컴퓨터에서 EC2인스턴스에 SSH로 접속하는 방법
![Pasted image 20230713101044.png](../../../../Pasted image 20230713101044.png)
...
## EC2 Spot Instances
![Pasted image 20230714122124.png](../../../../Pasted image 20230714122124.png)
...
![Pasted image 20230714123506.png](../../../../Pasted image 20230714123506.png)
